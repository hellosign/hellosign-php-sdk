...
/**
 * SubFormFieldsPerDocumentSignature Class Doc Comment
 *
 * @category Class
...
class SubFormFieldsPerDocumentSignature extends SubFormFieldsPerDocumentBase
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SubFormFieldsPerDocumentSignature';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = $data['type'] ?? 'signature';
    }

    public static function fromArray(array $data): SubFormFieldsPerDocumentSignature
    {
