...
class ApiAppResponseOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApiAppResponseOptions';
    ...
    protected static $getters = [
        'can_insert_everywhere' => 'getCanInsertEverywhere',
    ];
    ...
    {
        return $this->container['can_insert_everywhere'];
    }
    ...
    {
        $this->container['can_insert_everywhere'] = $can_insert_everywhere;
