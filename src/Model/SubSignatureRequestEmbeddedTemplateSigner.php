...
/**
 * SubSignatureRequestEmbeddedTemplateSigner Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
 ...
 */
class SubSignatureRequestEmbeddedTemplateSigner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SubSignatureRequestEmbeddedTemplateSigner';
    ...
    public static function fromArray(array $data): SubSignatureRequestEmbeddedTemplateSigner
    {
     ...
     * Sets role
     *
     * @param string $role Must match an existing role in chosen Template(s). Multiple signers cannot share the same role.
     *
     * @return self
     */
    ...
    public function setPin(?string $pin)
    {
        if (!is_null($pin) && (mb_strlen($pin) > 12)) {
            throw new InvalidArgumentException('invalid length for $pin when calling SubSignatureRequestEmbeddedTemplateSigner., must be smaller than or equal to 12.');
        }
        if (!is_null($pin) && (mb_strlen($pin) < 4)) {
            throw new InvalidArgumentException('invalid length for $pin when calling SubSignatureRequestEmbeddedTemplateSigner., must be bigger than or equal to 4.');
        }
