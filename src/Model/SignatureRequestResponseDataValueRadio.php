 ...
 */
class SignatureRequestResponseDataValueRadio extends SignatureRequestResponseData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SignatureRequestResponseDataValueRadio';
