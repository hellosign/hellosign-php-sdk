...
/**
 * SignatureRequestListResponse Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
...
class SignatureRequestListResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SignatureRequestListResponse';
    ...
    protected static $openAPITypes = [
        'signature_requests' => '\HelloSignSDK\Model\SignatureRequestResponse[]',
    ...
    {
        $this->container['signature_requests'] = $data['signature_requests'] ?? null;
        $this->container['list_info'] = $data['list_info'] ?? null;
        $this->container['warnings'] = $data['warnings'] ?? null;
    }

    public static function fromArray(array $data): SignatureRequestListResponse
    {
        /** @var SignatureRequestListResponse $obj */
