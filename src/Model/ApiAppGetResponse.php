...
class ApiAppGetResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApiAppGetResponse';
    ...
    {
        $this->container['api_app'] = $data['api_app'] ?? null;
    ...
    {
        $this->container['api_app'] = $api_app;
