...
class TemplateApi
{
    ...
    /**
     * Operation templateFilesAsEncodedString
     *
     ...
     */
    public function templateFilesAsEncodedString(string $template_id)
    {
        list($response) = $this->templateFilesAsEncodedStringWithHttpInfo($template_id);

        return $response;
    }

    /**
     * Operation templateFilesAsEncodedStringWithHttpInfo
     *
     * Get Template File as Encoded String
     *
     * @param string $template_id The id of the template files to retrieve. (required)
     ...
     */
    public function templateFilesAsEncodedStringWithHttpInfo(string $template_id)
    {
        $request = $this->templateFilesAsEncodedStringRequest($template_id);
    ...
    /**
     * Operation templateFilesAsEncodedStringAsync
     *
     * Get Template File as Encoded String
     *
     * @param string $template_id The id of the template files to retrieve. (required)
     ...
     * @return Promise\PromiseInterface
     */
    public function templateFilesAsEncodedStringAsync(string $template_id)
    {
        return $this->templateFilesAsEncodedStringAsyncWithHttpInfo($template_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation templateFilesAsEncodedStringAsyncWithHttpInfo
     *
     * Get Template File as Encoded String
     *
     * @param string $template_id The id of the template files to retrieve. (required)
     ...
     * @return Promise\PromiseInterface
     */
    public function templateFilesAsEncodedStringAsyncWithHttpInfo(string $template_id)
    {
        $returnType = '\HelloSignSDK\Model\FileResponseDataUri';
        $request = $this->templateFilesAsEncodedStringRequest($template_id);
    ...
    /**
     * Create request for operation 'templateFilesAsEncodedString'
     *
     * @param string $template_id The id of the template files to retrieve. (required)
     *
     * @throws InvalidArgumentException
     * @return Psr7\Request
     */
    public function templateFilesAsEncodedStringRequest(string $template_id)
    {
        // verify the required parameter 'template_id' is set
        if ($template_id === null || (is_array($template_id) && count($template_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $template_id when calling templateFilesAsEncodedString'
            );
        }

        $resourcePath = '/template/files/{template_id}?get_data_uri=1&file_type=pdf';
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function templateFilesAsFileUrlRequest(string $template_id)
    {
        ...
        $resourcePath = '/template/files/{template_id}?get_url=1&file_type=pdf';
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
