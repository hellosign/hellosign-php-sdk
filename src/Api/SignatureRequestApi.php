...
class SignatureRequestApi
{
    ...
    /**
     * Operation signatureRequestFilesAsEncodedString
     *
     ...
     */
    public function signatureRequestFilesAsEncodedString(string $signature_request_id)
    {
        list($response) = $this->signatureRequestFilesAsEncodedStringWithHttpInfo($signature_request_id);

        return $response;
    }

    /**
     * Operation signatureRequestFilesAsEncodedStringWithHttpInfo
     *
     * Download File as Encoded String
     *
     * @param string $signature_request_id The id of the SignatureRequest to retrieve. (required)
     ...
     */
    public function signatureRequestFilesAsEncodedStringWithHttpInfo(string $signature_request_id)
    {
        $request = $this->signatureRequestFilesAsEncodedStringRequest($signature_request_id);
    ...
    /**
     * Operation signatureRequestFilesAsEncodedStringAsync
     *
     * Download File as Encoded String
     *
     * @param string $signature_request_id The id of the SignatureRequest to retrieve. (required)
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestFilesAsEncodedStringAsync(string $signature_request_id)
    {
        return $this->signatureRequestFilesAsEncodedStringAsyncWithHttpInfo($signature_request_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation signatureRequestFilesAsEncodedStringAsyncWithHttpInfo
     *
     * Download File as Encoded String
     *
     * @param string $signature_request_id The id of the SignatureRequest to retrieve. (required)
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestFilesAsEncodedStringAsyncWithHttpInfo(string $signature_request_id)
    {
        $returnType = '\HelloSignSDK\Model\FileResponseDataUri';
        $request = $this->signatureRequestFilesAsEncodedStringRequest($signature_request_id);
    ...
    /**
     * Create request for operation 'signatureRequestFilesAsEncodedString'
     *
     * @param string $signature_request_id The id of the SignatureRequest to retrieve. (required)
     *
     * @throws InvalidArgumentException
     * @return Psr7\Request
     */
    public function signatureRequestFilesAsEncodedStringRequest(string $signature_request_id)
    {
        // verify the required parameter 'signature_request_id' is set
        if ($signature_request_id === null || (is_array($signature_request_id) && count($signature_request_id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $signature_request_id when calling signatureRequestFilesAsEncodedString'
            );
        }

        $resourcePath = '/signature_request/files/{signature_request_id}?get_data_uri=1&file_type=pdf';
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function signatureRequestFilesAsFileUrlRequest(string $signature_request_id)
    {
        ...
        $resourcePath = '/signature_request/files/{signature_request_id}?get_url=1&file_type=pdf';
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
